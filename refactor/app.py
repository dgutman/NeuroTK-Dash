...
# local imports
from src.utils.settings import APP_HOST, APP_PORT, DEV_TOOLS_PROPS_CHECK, MONGO_URI
...
server.config["MONGODB_SETTINGS"] = {"host": MONGO_URI}  # Replace with your MongoDB connection URI
